  ...
  return (function (t) {
      ...
      function g(t) {
        delete P[t.id],
          ...
          (k.inArray("docVisible", t.options.titleCount.conditions) ||
            k.inArray("docHidden", t.options.titleCount.conditions)) &&
            D.decrement(),
          s(t.options.queue);
      }
      Object.defineProperty(e, "__esModule", { value: !0 }),
      ...
      var _ = n(0),
        ...
        D = (e.docTitle = {
          ...
          _update: function () {
            ...
            S.changed
              ? (document.title = "(" + S.count + ") " + S.originalTitle)
              : ((S.originalTitle = t),
      ...
      (function (e, o) {
        ...
        !(function (e, n) {
          ...
          function D(t) {
            ...
            if (0 !== e.length) {
              for (
                var o = void 0, i = void 0, r = t._result, s = 0;
                s < e.length;
                s += 3
              )
          ...
          return (
            ...
            (M.prototype._settledAt = function (t, e, n) {
              var o = this.promise;
              o._state === et &&
                (this._remaining--, t === ot ? C(o, n) : (this._result[e] = n)),
        ...
        p = (function () {
          function t() {
            ...
            return (
              ...
              (this.closing = !1),
              (this.killable =
                this.options.timeout || this.options.closeWith.length > 0),
              ...
              [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    if (
                      ...
                      (this.closed = !1),
                      d.hasButtons(this) &&
                        Object.keys(this.options.buttons).forEach(function (t) {
                      ...
                      c.inArray("click", this.options.closeWith) &&
                        (c.addClass(this.barDom, "noty_close_with_click"),
                        c.addListener(
                          this.barDom,
                          "click",
                          function (t) {
                      ...
                      this.options.timeout &&
                        c.addClass(this.barDom, "noty_has_timeout"),
                      this.options.progressBar &&
                        c.addClass(this.barDom, "noty_has_progressbar"),
                    ...
                    return (
                      ...
                      null === this.options.animation.open
                        ...
                        : (c.addClass(this.barDom, this.options.animation.open),
                          (this.promises.show = new u.default(function (t) {
                            c.addListener(
                              e.barDom,
                ...
                },
                {
                  ...
                  value: (function (t) {
                    ...
                    if (
                      ...
                      this.options.timeout
                        ? c.addClass(this.barDom, "noty_has_timeout")
                        : c.removeClass(this.barDom, "noty_has_timeout");
                      var e = this;
                      setTimeout(function () {
                        e.resume();
                      }, 100);
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return (
                      this.barDom &&
                        (this.barDom.querySelector(".noty_body").innerHTML = t),
                    ...
                    return this.closed
                      ...
                      ? (d.fire(this, "onClose"),
                        ...
                        null === this.options.animation.close
                          ? (this.promises.close = new u.default(function (t) {
                              t();
                            }))
              ...
              [
                {
                  ...
                  value: function () {
                    var t =
                      ...
                      arguments[0];
                    return (
                      Object.keys(d.Store).forEach(function (e) {
                        t
                          ? d.Store[e].options.queue === t &&
                            d.Store[e].killable &&
                            d.Store[e].close()
                          : d.Store[e].killable && d.Store[e].close();
                      }),
                      this
                    );
                  },
    ...
    function (t, e) {
      ...
      function s() {
        m &&
          h &&
          ((m = !1), h.length ? (p = h.concat(p)) : (v = -1), p.length && u());
      }
      function u() {
        if (!m) {
          var t = i(s);
